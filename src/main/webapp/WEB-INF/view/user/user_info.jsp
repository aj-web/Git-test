    ...
    <head>
        ...
        <script language="javascript" type="text/javascript">
	        $(function(){
	    		$("#smit").click(function(){
	    			$.post({
	    				url: "/maventele/user/updateAdminInfo.do",
        ...
        <div id="main">            
            ...
            <form action="" method="post" class="main_form">
                ...
                <div class="input_info">
                    <input type="text" readonly="readonly" class="readonly width400" value="${Ad.lr_String }" />
                </div>
                ...
                <div class="input_info">
                    <input type="text" class="width200" value="${Ad.atel }" name="atel" />
                ...
                <div class="input_info"><input type="text" readonly="readonly" class="readonly" value="${Ad.creattime}"/></div>
